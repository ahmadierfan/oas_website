    ...
    <footer class="bg-brand-primary text-white py-12">
        <div class="container mx-auto px-6">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div data-aos="fade-up" data-aos-delay="100">
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="#" class="text-gray-400 hover:text-white transition-colors">Partnership</a>
                        </li>
                ...
                <div data-aos="fade-up" data-aos-delay="300">
                    ...
                    <ul class="space-y-2 text-gray-400">
                        ...
                        <li class="flex items-center space-x-2">
                            ...
                            <span>partnership@orionavia.com</span>
                        </li>
                        <li class="flex items-center space-x-2">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
                <p>&copy; 2025 ORION Aviation. All rights reserved.</p>
            </div>
        </div>
    </footer>
</template>